...
This file provides advanced mode guidance for agents with access to MCP tools and browser.

## Advanced Mode Capabilities

- Access to MCP (Model Context Protocol) tools
- Browser automation capabilities
- Extended tool access for complex operations
